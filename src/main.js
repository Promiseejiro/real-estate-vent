      ...
      <div className="App">
        <div className="real-main-container">
            ...
            <div className="dark-overlay">
              <div className="hero-content">
                ...
                >
                  ...
                  access, you can enjoy a seamless shopping experience every
                  time you visit. Come see us today and discover why we're the
          ...
          <section className="offer-section">
            {/* <div
              class="slate-spacer r2ud8k0"
              style={{ height: "125px", width: "700px" }}
            ></div> */}
            ...
            <div data-aos="zoom-in-up" className="">
              <h1 style={{ fontWeight: "bold", fontSize: 70, color: "#fff" }}>
                Why Choose Us
              </h1>
              <div
                class="slate-spacer r2ud8k0"
            ...
            <div data-aos="zoom-in-up" className="">
              <h1>
                <b
                  className="diaplay-1  "
                  style={{ fontWeight: "bold", fontSize: 70, color: "#fff" }}
                >
                  Our Statistics
                </b>
              </h1>
              <div className="container mt-8 mt-4">
                <div className="row">
